...
<div className="mb-6 overflow-x-auto">
  <table className="border-si-bluegreen/20 min-w-full border-collapse border">
    ...
    <tbody>
      ...
      <tr>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">Integration Failures</td>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">Medium</td>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">API Monitoring</td>
      </tr>
      <tr>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">Security Breaches</td>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">High</td>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">Encryption Protocols</td>
      </tr>
    </tbody>
  </table>
</div>
