...
tags: ['entertainment', 'cyber security', 'streaming', 'digital transformation', 'production insurance']
readTime: '6 min read'
...
<div className="mb-6 overflow-x-auto">
  <table className="border-si-bluegreen/20 min-w-full border-collapse border">
    ...
    <tbody>
      <tr>
        <td className="border-si-bluegreen/20 text-si-dark/80 border px-4 py-3">Content Theft & Piracy</td>
