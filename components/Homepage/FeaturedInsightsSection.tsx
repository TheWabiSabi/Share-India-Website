...
// If your carousel relies on window, disable SSR for smoother hydration
...
export default function FeaturedInsightsSection() {
  return (
    // No bg on the section — the parent CardScreen provides the white card
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="to-si-primary-400/60 h-2 w-16 rounded bg-gradient-to-r from-slate-300" />
