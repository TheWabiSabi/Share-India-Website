...
export default function RetailInsurancePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="border-b border-gray-100 bg-gradient-to-b from-si-primary-200 to-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* ── Core Coverage Suite ── */}
      <section className="border-b border-gray-100 bg-gradient-to-b from-white to-si-primary-200 py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeUp>
      ...
      <section className="border-b border-gray-100 bg-gradient-to-b from-si-primary-200 to-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <FadeUp>
