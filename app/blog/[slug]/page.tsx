    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="border-b bg-white">
        <div className="mx-auto max-w-4xl px-4 py-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-600">Understanding Stock Market Fundamentals</span>
          </nav>
        </div>
      </div>
        ...
        <article className="rounded-lg bg-white p-8 shadow-sm md:p-12">
          ...
          <div className="mt-12 border-t border-gray-200 pt-8">
            ...
            <div className="flex space-x-4">
              ...
              <button className="flex items-center space-x-2 rounded-lg bg-blue-800 px-4 py-2 text-white transition-colors hover:bg-blue-900">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <article className="overflow-hidden rounded-lg bg-white shadow-sm transition-shadow hover:shadow-lg">
            <div className="flex h-40 items-center justify-center bg-gradient-to-r from-purple-100 to-blue-100">
          ...
          <article className="overflow-hidden rounded-lg bg-white shadow-sm transition-shadow hover:shadow-lg">
            <div className="flex h-40 items-center justify-center bg-gradient-to-r from-blue-100 to-green-100">
