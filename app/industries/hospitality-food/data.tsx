...
export const details = {
  ...
  explaination: {
    ...
    overview: {
      ...
      bullets: [
        ...
        'Public liability / food liability insurance',
      ...
      types: [
        {
          ...
          title: 'Hotels',
          description: 'Rooms, guest areas, restaurants, and amenities',
        },
        {
          icon: <FaUtensils className="text-blue-500" />,
          title: 'Restaurants & Cafes',
          description: 'Dine-in food businesses and customer-facing outlets',
        },
        {
          icon: <FaStore className="text-blue-500" />,
          title: 'Cloud Kitchens & Catering',
          description: 'Delivery kitchens, events, and catering operations',
        },
      ],
    },
  },
  coverage: {
    desciption:
      'End-to-end protection for property, customer liability, food exposure, equipment, staff, and revenue interruption.',
    coverages: [
      {
        title: 'Property & Fire',
        icon: <FaFire className="text-3xl text-blue-500" />,
        body: 'Protection for premises, fixtures, interiors, and business assets.',
        bullets: [
          'Fire and allied perils insurance',
          'Business interruption insurance',
      ...
      {
        title: 'Food & Public Liability',
        icon: <FaShieldAlt className="text-3xl text-blue-500" />,
        body: 'Coverage for customer injury, food contamination, and third-party claims.',
        bullets: [
          'Public liability / food liability insurance',
      ...
      {
        title: 'Special Hospitality Risk',
        icon: <FaCocktail className="text-3xl text-blue-500" />,
        body: 'Coverage for alcohol service and hospitality-specific exposures.',
        bullets: [
          'Liquor liability (if applicable)',
          'Guest and event liability',
          'Reputational risk support',
        ],
      },
      {
        title: 'Kitchen & Staff Protection',
        icon: <FaUtensils className="text-3xl text-blue-500" />,
        body: 'Coverage for kitchen equipment, employee injury, and operating disruption.',
        bullets: [
          'Machinery breakdown (kitchen equipment)',
