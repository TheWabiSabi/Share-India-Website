...
const IndustriesServedSection = ({ industries }: { industries: IndustryServed[] }) => (
  <section className="border-t border-gray-100 bg-white py-10">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <ul className="mt-5 max-h-[34rem] divide-y divide-gray-100 overflow-y-auto rounded-xl border border-gray-100 bg-white">
        {industries.map((industry) => (
          <li
            key={industry.detail}
            className="flex flex-col items-start justify-between gap-3 px-4 py-3 sm:flex-row sm:items-center sm:gap-4"
          >
