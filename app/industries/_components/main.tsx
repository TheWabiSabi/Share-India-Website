...
const IndustryPage = ({
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl text-white">
              <div className="border-si-primary/30 bg-si-primary/15 mb-5 inline-flex items-center gap-2 rounded-full border px-4 py-2 backdrop-blur-sm">
                ...
                <span className="text-sm font-semibold text-blue-100">Industry Specialists • IRDAI Licensed</span>
              </div>
      ...
      {/* ── Knowledge Quiz ── */}
      <KnowledgeQuestionnaire questions={quizQuestions} industryName={details.knowledge.industryName} />
          ...
          <div className="border-si-primary/10 from-si-primary/5 overflow-hidden rounded-2xl border bg-gradient-to-br to-white p-8 shadow-sm md:p-10">
            <div className="grid grid-cols-1 items-center gap-6 lg:grid-cols-3">
              <div className="lg:col-span-2">
                <h3 className="text-si-ink text-2xl font-bold">Building Tomorrow. Protecting Today.</h3>
                <p className="text-si-ink/70 mt-2">
                  Partner with SIIB&apos;s specialists for comprehensive project coverage, performance
                  guarantees, and expert risk management.
                </p>
              </div>
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
              ...
              <Contact label="Advisory Desk" value="Infrastructure Specialists" icon={<FaHeadset />} />
            </div>
          </div>
        </div>
      </section>
