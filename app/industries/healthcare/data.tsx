...
export const details = {
  ...
  explaination: {
    ...
    overview: {
      ...
      bullets: [
        ...
        'Clinical establishment all-risk property cover',
      ...
      types: [
        {
          ...
          title: 'Hospitals',
          description: 'Multi-specialty, surgical, and inpatient facilities',
        },
        {
          icon: <FaStethoscope className="text-blue-500" />,
          title: 'Clinics & Pharmacies',
          description: 'Outpatient care, pharmacies, and specialist practices',
        },
        {
          icon: <FaBriefcaseMedical className="text-blue-500" />,
          title: 'Diagnostic Centres',
          description: 'Labs, imaging centres, and diagnostic services',
        },
      ],
    },
  },
  coverage: {
    desciption:
      'Specialized protection for medical liability, healthcare assets, employees, equipment, and patient data.',
    coverages: [
      {
        title: 'Professional Liability',
        icon: <FaUserMd className="text-3xl text-blue-500" />,
        body: 'Protection for malpractice and professional negligence claims.',
        bullets: [
          'Medical malpractice / professional indemnity',
      ...
      {
        title: 'Facility & Public Risk',
        icon: <FaHospital className="text-3xl text-blue-500" />,
        body: 'Coverage for clinical premises, assets, patients, visitors, and public liability.',
        bullets: [
          'Clinical establishment all-risk property cover',
          'Public liability insurance',
      ...
      },
      {
        ...
        body: 'Protection for healthcare employees and critical medical equipment.',
        bullets: [
      ...
      },
      {
        ...
        icon: <FaLaptopMedical className="text-3xl text-blue-500" />,
        body: 'Cyber coverage for digital records, patient data, and healthcare systems.',
        bullets: [
          'Cyber liability (patient data protection)',
  ...
  claim_story: {
    description:
      'Stay updated with how SIIB helped healthcare clients respond to malpractice, equipment, property, and cyber claims.',
    topic: 'healthcare',
  },
  relevant: { tagSlug: 'healthcare' },
