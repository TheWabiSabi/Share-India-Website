...
export const details = {
      ...
      types: [
        {
          ...
          description: 'Product, services, SaaS, and managed technology firms',
        },
        {
          icon: <FaNetworkWired className="text-blue-500" />,
          title: 'BPOs',
          description: 'Voice, back-office, and data processing operations',
        },
        {
          icon: <FaBriefcase className="text-blue-500" />,
          title: 'Professional Offices',
          description: 'Consulting and other office-based businesses',
        },
      ],
    },
  },
  coverage: {
    desciption:
      'Tailored protection for cyber incidents, professional liability, management liability, employees, assets, and interruption.',
    coverages: [
      {
        title: 'Cyber & Data Risk',
        icon: <FaShieldAlt className="text-3xl text-blue-500" />,
        body: 'Protection against cyber attacks, data breach events, and incident response costs.',
        bullets: [
          'Cyber liability and data breach insurance',
          'Client data exposure support',
      ...
      },
      {
        ...
        body: 'Coverage for service errors, omissions, and professional negligence claims.',
        bullets: [
          'Errors & Omissions (E&O) / Professional indemnity',
          'Contractual liability support',
      ...
      },
      {
        ...
        body: 'Protection for directors, officers, employees, and workplace benefits.',
        bullets: [
          'Directors & Officers (D&O) liability',
          'Group health and personal accident cover',
          'Employee risk protection',
        ],
      },
      {
        title: 'Office Assets & Continuity',
        icon: <FaBuilding className="text-3xl text-blue-500" />,
        body: 'Coverage for office equipment, contents, and revenue disruption.',
        bullets: [
          'Office contents and equipment insurance',
          'Business interruption insurance',
          'Remote and office operation support',
        ],
      },
    ],
  },
  claim_story: {
    description:
      'Stay updated with how SIIB helped IT and office clients respond to cyber, liability, employee, and property claims.',
    topic: 'it_offices',
  },
  relevant: { tagSlug: 'it_offices' },
