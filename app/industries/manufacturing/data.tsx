...
export const details = {
      ...
      types: [
        {
          ...
          description: 'Production facilities, utilities, and industrial premises',
        },
        {
          icon: <FaCogs className="text-blue-500" />,
          title: 'Machinery-Driven Units',
          description: 'Equipment-intensive manufacturing operations',
        },
        {
          icon: <FaBoxes className="text-blue-500" />,
          title: 'Stock & Supply Chains',
          description: 'Raw materials, finished goods, and transit exposure',
        },
      ],
    },
  },
  coverage: {
    desciption:
      'Comprehensive protection for manufacturing assets, machinery, products, workers, interruption, and cargo movement.',
    coverages: [
      {
        title: 'Industrial Property',
        icon: <FaFire className="text-3xl text-blue-500" />,
        body: 'Protection against fire, allied perils, and physical loss to industrial assets.',
        bullets: [
          'Industrial all-risk / fire and allied perils',
          'Stock and plant protection',
          'Factory property coverage',
        ],
      },
      {
        title: 'Machinery & Operations',
        icon: <FaCogs className="text-3xl text-blue-500" />,
        body: 'Coverage for sudden machinery breakdown and operational disruption.',
        bullets: [
          'Machinery breakdown insurance',
      ...
      {
        title: 'Product & Worker Liability',
        icon: <FaShieldAlt className="text-3xl text-blue-500" />,
        body: 'Protection for product-related claims and employee injuries.',
        bullets: [
          'Product liability insurance',
          "Workmen's compensation",
          'Manufacturing liability claims',
        ],
      },
      {
        title: 'Transit & Supply Chain',
        icon: <FaTruck className="text-3xl text-blue-500" />,
        body: 'Coverage for goods moving through suppliers, plants, warehouses, and customers.',
        bullets: [
          'Marine / cargo insurance for goods in transit',
          'Supply chain disruption support',
          'Finished goods movement protection',
        ],
      },
    ],
  },
  claim_story: {
    description:
      'Stay updated with how SIIB helped manufacturing clients recover from fire, machinery, product liability, and cargo claims.',
    topic: 'manufacturing',
  },
  relevant: { tagSlug: 'manufacturing' },
