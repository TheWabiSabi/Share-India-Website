export const quizQuestions = [
  {
    ...
    correctAnswer: 0,
    explanation:
      'Student personal accident cover is designed to provide benefits after covered student accidents.',
  ...
  },
  {
    ...
    options: [
      'For visitor and third-party injury claims on campus',
      'For only vehicle fuel costs',
      'For only product exports',
      'For only cargo storage',
    ],
    correctAnswer: 0,
    explanation:
      'Schools and colleges have regular student, parent, vendor, and visitor footfall, creating public liability exposure.',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Cyber liability helps address data breach, digital platform, and online learning technology risks.',
    difficulty: 'medium' as const,
  },
  {
    id: '4',
    ...
    options: [
      ...
      'Personal accident for students only',
      'Shop stock cover only',
      'Travel delay only',
    ],
    correctAnswer: 0,
    explanation:
      'D&O liability protects directors and officers against covered claims linked to management decisions.',
